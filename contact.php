            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6">
                    ...
                    <form action="contact.php" method="POST">
                        ...
                        <div class="mb-3" data-aos="fade-up" data-aos-duration="1000">
                            <label for="subject" class="form-label" data-aos="fade-up">Subjek</label>
                            <input type="text" class="form-control" id="subject" name="subject" required>
                        </div>
                        <div class="mb-3" data-aos="fade-up" data-aos-duration="1000">
                            <label for="message" class="form-label" data-aos="fade-up">Pesan</label>
                ...
                <div class="col-md-6" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <p>Anda juga dapat menghubungi kami melalui informasi kontak di bawah ini:</p>
