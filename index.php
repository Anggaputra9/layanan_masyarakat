            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-duration="1000">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="services.php" class="btn btn-primary">Selengkapnya</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4" data-aos="fade-up" data-aos-duration="1000">
    ...
    <section class="bg-light py-5">
        <div class="container">
            ...
            <div class="text-center mt-5">
                <a href="news.php" class="btn btn-outline-primary" data-aos="fade-up" data-aos-duration="1000">Lihat Berita Lainnya</a>
            </div>
